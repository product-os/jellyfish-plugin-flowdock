export default {
	...
	'new-message-pinging-non-existent-user': {
		...
		steps: [require('./new-message-pinging-non-existent-user/01.json')],
	},
	...
	'new-message-with-big-body': {
		...
		steps: [require('./new-message-with-big-body/01.json')],
	},
	'new-message-with-file-attachment': {
		expected: require('./new-message-with-file-attachment/expected.json'),
		steps: [require('./new-message-with-file-attachment/01.json')],
	},
	...
	'new-message-with-two-tags': {
		...
		steps: [require('./new-message-with-two-tags/01.json')],
	},
